...
import Util.TextTools.lemmatizeText
...
*/
  ...
  def main(args: Array[String]) {
    ...
    // In text processing, a “set of terms” might be a bag of words. The algorithm combines Term Frequency (TF) counts with the hashing trick for dimensionality reduction.
